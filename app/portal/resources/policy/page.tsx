...
const SOPsPoliciesPage: React.FC = () => {
  ...
  const fetchResources = async (): Promise<void> => {
    try {
      ...
      const filtered = (response.results || []).filter(
        (r: Resource) => r.type?.toLowerCase() === 'sops and policies'
      );
      setResources(filtered);
    } catch (err) {
      setError('Failed to fetch SOPs and policies');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleCreateResource = async (): Promise<void> => {
    try {
      ...
      setError('Failed to create SOP/policy');
  ...
  const handleEditResource = (resource: Resource): void => {
    ...
    setFormData({
      ...
      type: resource.type || "sops and policies",
  ...
  const handleUpdateResource = async (): Promise<void> => {
    ...
    try {
      ...
      setError('Failed to update SOP/policy');
    ...
    <div className="lg:p-6 p-0 space-y-6">
      {loading && (
        <div className="flex justify-center items-center py-8">
          ...
          <span className="text-gray-600">Loading SOPs and policies...</span>
        </div>
      )}
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Manage standard operating procedures and organizational policies
          </p>
        </div>
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>Create SOP/Policy</DialogTitle>
            </DialogHeader>
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  id="tags"
                  placeholder="e.g., HR, finance, operations, compliance"
                  value={formData.tags}
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="is_public">Make this SOP/policy public</Label>
              </div>
      ...
      <Card>
        <CardContent className="p-4">
          <div className="relative">
            ...
            <Input
              placeholder="Search SOPs and policies by title, description, tags, or reference number..."
              className="pl-10"
              value={searchQuery}
      ...
      <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>SOP/Policy Details</DialogTitle>
          </DialogHeader>
          {selectedResource && (
            <div className="space-y-4">
              <div>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Edit SOP/Policy</DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            <div>
            ...
            <div className="flex items-center space-x-2">
              <Switch
                ...
                onCheckedChange={(checked) => handleFormDataChange('is_public', checked)}
              />
              <Label htmlFor="edit-is_public">Make this SOP/policy public</Label>
            </div>
            <div className="flex justify-end gap-3 pt-4">
              <Button 
                type="button" 
...
export default SOPsPoliciesPage;