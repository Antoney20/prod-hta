...
const SHAGuidelinesPage: React.FC = () => {
  ...
  const fetchResources = async (): Promise<void> => {
    try {
      ...
      const filtered = (response.results || []).filter(
        (r: Resource) => r.type?.toLowerCase() === 'sha guidelines'
      );
      setResources(filtered);
    } catch (err) {
      setError('Failed to fetch SHA guidelines');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleCreateResource = async (): Promise<void> => {
    try {
      ...
      setError('Failed to create SHA guideline');
  ...
  const handleEditResource = (resource: Resource): void => {
    ...
    setFormData({
      ...
      type: resource.type || "sha guidelines",
  ...
  const handleUpdateResource = async (): Promise<void> => {
    ...
    try {
      ...
      setError('Failed to update SHA guideline');
    ...
    <div className="lg:p-6 p-0 space-y-6">
      {loading && (
        <div className="flex justify-center items-center py-8">
          ...
          <span className="text-gray-600">Loading SHA guidelines...</span>
        </div>
      )}
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">SHA Guidelines</h1>
          <p className="text-gray-600 mt-2">
            Manage SHA guidelines, protocols, and standards
          </p>
        </div>
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>Create SHA Guideline</DialogTitle>
            </DialogHeader>
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  id="tags"
                  placeholder="e.g., protocol, standard, compliance"
                  value={formData.tags}
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="is_public">Make this guideline public</Label>
              </div>
      ...
      <Card>
        <CardContent className="p-4">
          <div className="relative">
            ...
            <Input
              placeholder="Search guidelines by title, description, tags, or reference number..."
              className="pl-10"
              value={searchQuery}
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              <Switch
                ...
                onCheckedChange={(checked) => handleFormDataChange('is_public', checked)}
              />
              <Label htmlFor="edit-is_public">Make this guideline public</Label>
            </div>
            <div className="flex justify-end gap-3 pt-4">
              <Button 
                type="button" 
...
export default SHAGuidelinesPage;