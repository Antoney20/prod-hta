  ...
  const fetchResources = async (): Promise<void> => {
    try {
      ...
      const filtered = (response.results || []).filter(
        (r: Resource) => r.type?.toLowerCase() === 'templates'
      );
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Manage document templates, forms, and standardized documents
          </p>
        </div>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  id="tags"
                  placeholder="e.g., form, letter, report, contract"
                  value={formData.tags}
      ...
      <Card>
        <CardContent className="p-4">
          <div className="relative">
            ...
            <Input
              placeholder="Search templates by title, description, tags, or reference number..."
              className="pl-10"
              value={searchQuery}
