...
function ReportFooter({ meta }: { meta: ReportMeta }) {
  return (
    <footer className="border-t border-dashed border-slate-200 px-6 py-6 sm:px-10">
      <p className="text-sm font-semibold text-slate-700">
        System-generated report for {meta.name} ({meta.reference}).
...
function ServiceTabs({
  ...
  services: ServiceReport[]; active: number; onSelect: (i: number) => void;
}) {
  return (
    <div className="mt-5">
      <p className="mb-2 text-[11px] font-semibold uppercase tracking-wide text-slate-400">
        Services in this submission
      </p>
