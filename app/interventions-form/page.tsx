  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="max-w-6xl mx-auto py-8 mt-20 px-4 ">
        ...
        <p className="font-medium text-lg text-gray-800 mb-4">
          The proposals will be received by the HBTAP secretariat through various channels including direct requests by the Panel to key stakeholders; scheduled stakeholder meetings or forums; or digital platforms including <span className='text-[#27aae1]'>hbtap@uonbi.ac.ke</span> or by filling the form below.
        </p>
      </section>
      <BenefitsForm />
      <Footer />
