...
const DecisionsPage: React.FC = () => {
  ...
  const fetchRecords = async (): Promise<void> => {
    try {
      ...
      const filtered = (response.results || []).filter(
        (r: Record) => r.type === 'resolutions_decisions'
      );
      setRecords(filtered);
    } catch (err) {
  ...
  const handleEditRecord = (record: Record): void => {
    ...
    setFormData({
      title: record.title,
      type: record.type || 'resolutions_decisions',
    ...
    <div className="lg:p-6 p-0 space-y-6">
      {loading && (
        <div className="flex justify-center items-center py-8">
          ...
          <span className="text-gray-600">Loading decisions...</span>
        </div>
      )}
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Resolutions & Decisions</h1>
          <p className="text-gray-600 mt-2">
            Manage board resolutions, committee decisions, and official determinations
          </p>
        </div>
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>Create Resolution/Decision</DialogTitle>
            </DialogHeader>
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="Enter resolution/decision title"
                  required
                />
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Detailed notes about the resolution or decision made..."
                  rows={4}
                />
              </div>
      ...
      <Card>
        <CardContent className="p-4">
          <div className="relative">
            ...
            <Input
              placeholder="Search decisions by title, description, or reference number..."
              className="pl-10"
              value={searchQuery}
          ...
          {selectedRecord && (
            <div className="space-y-4">
              ...
              {selectedRecord.description && (
                <div>
                  <h4 className="font-medium mb-2">Description/Resolution Notes</h4>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div>
              <Label htmlFor="edit-description">Description/Resolution Notes</Label>
              <Textarea
                id="edit-description"
                value={formData.description}
                onChange={(e) => handleFormDataChange('description', e.target.value)}
